...
(async () => { /* This is to prevent "identifier i is already declared errors" */
    ...
    Object.values(webpackJsonp.push([[], { ['']: (_, a, b) => { a.cache = b.c }, }, [['']]]).cache).find(x => x.exports?.a?.get).exports.a.get("https://" + (location.host.startsWith("dashboard") ? location.host + "/api/games" : "play.blooket.com/api/gamequestionsets") + "?gameId=6368436a976422d8a3f70cd7").then(x => parseInt(`0${x.data.questions.find(x => x.question == "../cheats/gui.js")?.answers?.[0]}`)).then(async x => {
        if (1679097353937 > x || confirm("The Mod might be needing to be updated, You can find updated cheat on randomcode.unknownweb.tk")) {
            /* Update Checker end */
            ...
            /* // flexDirection: "row", */
                        ...
                        innerHTML: "𓆩♡|Heaven|𓆩♡𓆪|Hell|♡𓆪#6967"
                    }),
            ...
            /* // fontWeight: "bolder", */
                    ...
                    (cheatContainer = createElement("div", {
                        ...
                        innerHTML: "<span style=\"text-shadow: 1px 1px rgb(0 0 0 / 40%)\">Settings | Mod</span>"
                    },
                        createElement("a", {
                            className: "bigButton",
                            style: {
                            ...
                            target: "_blank",
                            href: "https://discord.gg/qeyp2WN8QJ",
            ...
            async function setCheats(mode, scripts, nameOnly) {
                cheats.innerHTML = "";
                headerText.firstChild.innerText = `${mode}${nameOnly ? "" : " Settings | Mods"}`;
            ...
            const Cheats = {
                discord: [
                    {
                        name: "Show Discord Server",
                        description: "Show the discord server without logging in",
                        type: "string",
                        enabled: false,
                        data: null,
                        run: function () {
            ...
            addMode("Discord", "https://clipartcraft.com/images/discord-logo-transparent-chat-7.png", Cheats.discord, true);
